...
//      그 이후에 문자열과 두번째 숫자(2000)과의 연산이 발생하여 '로세티리 바베큐 세트 65002000원' 이라는 형태로
//      화면에 출력이 된다.
        System.out.println(menu + menu2 + price + price2 + "원");
...
//      전위 연산 혹은 후위 연산이 단독으로 사용될 경우에는 일반 연산자를 통해서
//      값을 증감시키는 것과 차이가 없음.
//      전위 연산 혹은 후위 연산을 다른 연산식과 함께 사용할 경우 실행되는 시점이 달라짐.
        ...
        System.out.println("op++ 이후의 값 : " + op);
        op--;
        System.out.println("op-- 이후의값 : " + op);
        --op;
        System.out.println("--op 이후의값 : " + op);
        System.out.println("\n");

        op = 10;
        System.out.println("현재 변수 op의 값 : " + op);     //10
        System.out.println("++op 실행 후의 값 : " + ++op);   //11
        System.out.println("현재 op의 값 : " + op);         //11
        System.out.println("op++ 실행 후의 값 : " + op++);   //11

        System.out.println("현재 op의 값 : " + op);          //12
        System.out.println("op-- 실행 후의 값 : " + op--);   //12

        System.out.println("현재 op의 값 : " + op);          //11

        System.out.println("--op 실행 후의 값 : " + --op);   //10
        System.out.println("현재 op의 값 : " + op);         //10
        ...
        // num1이 num2보다 크면 ? -> num1-num2=true, num2-num1=false, false 이므로 num2-num1=2
